...
class PortfolioDesc(models.Model):
    tittle_section = models.CharField(_("Título de Sección"), max_length=100, default="Portfolio")
...
class PortfolioItem(models.Model):
    ...
    category = models.CharField(_("Tipo de Filtro"), max_length=50, choices=CATEGORY_CHOICES)
    description = models.TextField(_("Descripcion del Proyecto"))
    image1 = models.ImageField(_("Imagen 1"), upload_to='portfolio/', validators=[validate_image_size])
    image2 = models.ImageField(_("Imagen 2"), upload_to='portfolio/', blank=True, null=True, validators=[validate_image_size])
    image3 = models.ImageField(_("Imagen 3"), upload_to='portfolio/', blank=True, null=True, validators=[validate_image_size])
